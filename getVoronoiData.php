<?php
	...
	else if(isset($_SESSION["user_id"])) 
	{
		if(isLoginSessionExpired()) 
		{
			...
			switch ($col) {
				case "main":
					$sql = "SELECT gid,name,latitude,longitude,geom,ST_AsGeoJSON(geom) AS geojson FROM flagpoints;";
					break;
				case "amazon":
					$sql = "SELECT gid,name,latitude,longitude,geom,ST_AsGeoJSON(geom) AS geojson FROM amazon;";
					break;
				case "sysco":
					$sql = "SELECT gid,name,latitude,longitude,geom,ST_AsGeoJSON(geom) AS geojson FROM sysco;";
					break;
				case "usf":
					$sql = "SELECT gid,name,latitude,longitude,geom,ST_AsGeoJSON(geom) AS geojson FROM usfoods;";
					break;
				default:
