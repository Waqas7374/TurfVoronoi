...
<!-- main content -->
				...
				<div class="wizard-container wizard-1" id="wizard-demo-1" style="margin-top: 50px">
					<form action="#" class="max-width-400 h-center">
						...
						<fieldset class="step">
							...
							<div class="form-group form-control-default required">
								<label for="wiz-email">E-mail or Username:</label>
								<input class="form-control" type="text" id="wiz-email" placeholder="E-mail or Username" />
							</div>
							<div class="form-group form-control-default required">
							...
							<div class="row">
								<div class="col-xs-12 text-center">
									<button type="button" class="wiz-next btn btn-primary">Login</button>
								</div>
							</div>
							<hr>
							<div class="row">
